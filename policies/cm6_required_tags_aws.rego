...
# description: "Every taggable AWS resource must carry the four required compliance tags."
# custom:
#   control_id: CM-6
#   framework: nist-800-53
#   severity: medium
#   remediation: "Add the missing tags to the resource or use provider default_tags to apply them globally."
